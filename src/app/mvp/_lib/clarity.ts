...
export function createDemoWorldPreset(): DemoWorldPreset {
    ...
    sceneDocument = replaceEnvironmentOnSceneDocument(sceneDocument, {
        ...
        sourceLabel: "Sample shell still",
        statusLabel: "Sample shell loaded",
    });
    ...
    return {
        ...
        summary: "A reference shell that shows the persistent room state before you attach a real source.",
        inputLabel: "Sample shell still",
        sceneDocument,
